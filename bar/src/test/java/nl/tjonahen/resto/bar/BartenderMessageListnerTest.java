...
class BartenderMessageListnerTest {
  @Mock private BartenderService serviceMock;
  @Mock private ObjectMapper objectMapperMock;

  @InjectMocks private BartenderMessageListner sut;
  ...
  void testReceiveDrink() throws Exception {
    ...
    when(serviceMock.getAllDrinks())
        .thenReturn(Arrays.asList(new Drink("test-ref", "test-drink", "short drink", 1L, 0L)));
